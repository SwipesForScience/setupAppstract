<template>
  <div>
    ...
    <b-textarea placeholder="Copy/paste your firebase API keys from the firebase console in here"
    :rows="5" v-model="fkeys"/>

    <b-button class="mt-2 mb-2" variant="secondary" @click="parseFirebaseKeys"
    :disabled="!fkeys">Apply</b-button>
    </div>
